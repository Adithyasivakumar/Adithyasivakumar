Hey chat this is my github README.md file
...
When i run this all my functions run except a small part which i have mentioned in the image.

My github streak section.



So without changing the entire code just fix the issue. Make sure all other code is same and run without any issues.
