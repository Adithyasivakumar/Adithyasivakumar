...
*Developed and optimized web applications using Django and REST Framework.*

- Designed RESTful APIs and integrated frontend with Bootstrap.  
- Collaborated on backend architecture and version control via Git.  
- Focused on modular, scalable application structure.

### 🧠 Intern — **KGXperience (Team KGX)**
*Worked on AI-driven systems and performance tracking tools.*

- Contributed to **Knowledge Engineering** and automation initiatives.  
- Implemented ML-based analysis tools for student development.  
- Learned project deployment and system design in real-world context.
...
|-----------|---------------|
| **Core** | ![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white) ![C](https://img.shields.io/badge/C-00599C?style=for-the-badge&logo=c&logoColor=white) ![C++](https://img.shields.io/badge/C++-00599C?style=for-the-badge&logo=cplusplus&logoColor=white) |
...
### 💻 GeeksforGeeks Stats  
[![GeeksforGeeks Stats](https://geeks-for-geeks-stats-api.vercel.app/?username=adithyasivttjd&theme=dark)](https://www.geeksforgeeks.org/user/adithyasivttjd/)
<br>
